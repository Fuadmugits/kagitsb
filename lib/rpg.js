...
const RPG_SHOP = {
    weapon: [
        { id: 'w1', name: 'Iron Sword', price: 1000, rarity: 'Common', grade: 'C', stats: { power: 150, defense: 0, luck: 5 } },
        { id: 'w2', name: 'Steel Blade', price: 5000, rarity: 'Uncommon', grade: 'B', stats: { power: 300, defense: 0, luck: 10 } },
        { id: 'w3', name: 'Mithril Greatsword', price: 25000, rarity: 'Rare', grade: 'A', stats: { power: 750, defense: 0, luck: 15 } }
    ],
    helmet: [
        { id: 'h1', name: 'Iron Helmet', price: 1000, rarity: 'Common', grade: 'C', stats: { power: 15, defense: 45, luck: 22 } },
        { id: 'h2', name: 'Steel Helm', price: 5000, rarity: 'Uncommon', grade: 'B', stats: { power: 30, defense: 90, luck: 45 } },
        { id: 'h3', name: 'Mithril Crown', price: 25000, rarity: 'Rare', grade: 'A', stats: { power: 75, defense: 225, luck: 112 } }
    ],
    armor: [
        { id: 'a1', name: 'Iron Chestplate', price: 1000, rarity: 'Common', grade: 'C', stats: { power: 15, defense: 90, luck: 15 } },
        { id: 'a2', name: 'Steel Armor', price: 5000, rarity: 'Uncommon', grade: 'B', stats: { power: 30, defense: 180, luck: 30 } },
        { id: 'a3', name: 'Mithril Plate', price: 25000, rarity: 'Rare', grade: 'A', stats: { power: 75, defense: 450, luck: 75 } }
    ],
    glove: [
        { id: 'g1', name: 'Iron Gloves', price: 1000, rarity: 'Common', grade: 'C', stats: { power: 37, defense: 30, luck: 30 } },
        { id: 'g2', name: 'Steel Gauntlets', price: 5000, rarity: 'Uncommon', grade: 'B', stats: { power: 75, defense: 60, luck: 60 } },
        { id: 'g3', name: 'Mithril Fists', price: 25000, rarity: 'Rare', grade: 'A', stats: { power: 187, defense: 150, luck: 150 } }
    ],
    legging: [
        { id: 'l1', name: 'Iron Leggings', price: 1000, rarity: 'Common', grade: 'C', stats: { power: 15, defense: 60, luck: 15 } },
        { id: 'l2', name: 'Steel Greaves', price: 5000, rarity: 'Uncommon', grade: 'B', stats: { power: 30, defense: 120, luck: 30 } },
        { id: 'l3', name: 'Mithril Guards', price: 25000, rarity: 'Rare', grade: 'A', stats: { power: 75, defense: 300, luck: 75 } }
    ],
    shoe: [
        { id: 's1', name: 'Iron Boots', price: 1000, rarity: 'Common', grade: 'C', stats: { power: 7, defense: 30, luck: 45 } },
        { id: 's2', name: 'Steel Boots', price: 5000, rarity: 'Uncommon', grade: 'B', stats: { power: 15, defense: 60, luck: 90 } },
        { id: 's3', name: 'Mithril Treads', price: 25000, rarity: 'Rare', grade: 'A', stats: { power: 37, defense: 150, luck: 225 } }
    ]
};
...
const RAID_BOSSES = [
    { name: 'Ancient Behemoth', hp: 20000, color: '🔴' },
    { name: 'Shadow Monarch', hp: 25000, color: '🟣' },
    { name: 'Crystal Dragon', hp: 30000, color: '💎' },
    { name: 'Abyssal Titan', hp: 40000, color: '⚫' }
];

const ACTIVE_RAIDS = {}; // Key: chatJid -> { boss, currentHp, participants: { jid: damage }, summonedBy }

const Raid = {
    summon(chatJid, userJid) {
        if (ACTIVE_RAIDS[chatJid]) return { status: 'active', raid: ACTIVE_RAIDS[chatJid] };
        
        const bossTemplate = RAID_BOSSES[Math.floor(Math.random() * RAID_BOSSES.length)];
        const newRaid = {
